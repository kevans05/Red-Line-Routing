...
class RedLineApp(tk.Tk):
    ...
    def _apply_wizard_result(self, result):
        ...
        try:
            ...
            for sub in ("Drawings", "Relay Settings", "Maintenance Standards", "CROW Outage", "Other",
    ...
    def _open(self):
        ...
        try:
            ...
            self.title_notes.insert("1.0", self.title_page.get("notes", ""))
            self._refresh_list(); self._refresh_drawings_list()
            self._refresh_relay_list(); self._refresh_maintenance_list(); self._refresh_crows()
