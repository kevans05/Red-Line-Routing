...
Single-file application — layers in dependency order, top to bottom:
  ...
  9. Global app database                  _AppDB (~/.redlinerouting.db),
                                          _GlobalDrawingCache
 10. Startup flow                         SoftwareSetupDialog, LandingDialog
...
class LandingDialog(tk.Toplevel):
    ...
    def _build(self):
        ...
        _action_card(body, "✦", "Create New Project",
                     "Open a blank planner and start adding jobs",
                     "#1e6b3c", "#1e8449", lambda: self._choose("new_quick"))
    ...
    def _startup_flow(self):
        ...
        Sequence:
          ...
          2. Always show LandingDialog so the user can open an existing project
             or start a quick blank plan.
          3. Dispatch based on the user's choice (open / quick-start).
        """
